const menu = [
  ...
  const btnMemu = document.querySelector ("#btn-menu")
  ...
  const btnAll = document
    .querySelector("#All").addEventListener("click", listAllFoods);
  const btnKorean = document
    .querySelector("#Korea").addEventListener("click", listKoreanFoods);
  const btnJapan = document
    .querySelector("#Japan").addEventListener("click", listJapanFoods);
  const btnChina = document
    .querySelector("#China").addEventListener("click", listChinaFoods);
  
  // Lists all dishes, works when the page is first loaded and all button is triggered
  ...
  // build the structure of the food
